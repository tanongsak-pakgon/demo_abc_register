<div class="coursesUsers index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('days_attended'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($coursesUser['CoursesUser']['days_attended']); ?>&nbsp;</td>
		<td><?php echo h($coursesUser['CoursesUser']['score']); ?>&nbsp;</td>
		<td><?php echo h($coursesUser['CoursesUser']['grade']); ?>&nbsp;</td>
		<td><?php echo h($coursesUser['CoursesUser']['status']); ?>&nbsp;</td>
		<td><?php echo h($coursesUser['CoursesUser']['created']); ?>&nbsp;</td>
		<td><?php echo h($coursesUser['CoursesUser']['modified']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $coursesUser['CoursesUser']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $coursesUser['CoursesUser']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
