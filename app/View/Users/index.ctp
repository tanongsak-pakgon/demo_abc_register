<div class="users index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('ref_code'); ?></th>
			<th><?php echo $this->Paginator->sort('username'); ?></th>
			<th><?php echo $this->Paginator->sort('password'); ?></th>
			<th><?php echo $this->Paginator->sort('name_prefix_id'); ?></th>
			...
			<th><?php echo $this->Paginator->sort('moo'); ?></th>
			<th><?php echo $this->Paginator->sort('road'); ?></th>
			<th><?php echo $this->Paginator->sort('sub_district'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($user['User']['ref_code']); ?>&nbsp;</td>
		...
		<td><?php echo h($user['User']['office_phone']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['mobile_phone']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['birth_date']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['address']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['moo']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['road']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['sub_district']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['district']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['province']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['zipcode']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['status']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['picture_path']); ?>&nbsp;</td>
